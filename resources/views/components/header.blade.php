...
<body class="font-sans">
    <header class="bg-[#f4dca8] py-4 px-6 md:flex md:items-center md:justify-between">
        ...
        <div class="flex flex-col md:flex-row  md:w-2/3 lg:w-1/2">
            ...
            <div class="md:w-25 flex">
                ...
                <div class="md:w-72  flex mt-4 md:mt-0">
                    <input type="text"
                        class="border border-gray-300 py-2 px-4 md:px-16  focus:outline-none focus:border-blue-500 w-96"
                        placeholder="I want to make puja / Homam .....">
                    <button class="px-4 py-2 bg-amber-500  md:mt-0 w-full md:w-auto">Search</button>
                </div>
            </div>
        ...
        <div class="flex justify-even md:items-center gap-4">
            ...
            <span class="flex justify-center items-center gap-2">
                ...
                <span class="flex flex-col">
                    <a class=" font-medium  text-sm block ">
                        Login
                    </a>
                    <a class=" font-medium  text-sm block">
                        Register
